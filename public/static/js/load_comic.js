		...
		$.ajax({
			...
			success:function(rsdata){
				for(var x=0; x<rsdata.length; x++){
					...
					a2.append(span);
					*/
					var li = $('<li><a data-pjax href="' + rsdata[x].cn + ' class="pic"><img data-original="' + rsdata[x].cv + 'alt="' + rsdata[x].ti + '></a><p class="cover"><a data-pjax href="' + rsdata[x].cn ' class="pic2"><span>' + rsdata[x].ti + '</span></a></p></li>');
					$("#ccover").append(li);
				}
				//懒加载
