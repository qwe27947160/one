    ...
    public function index() {
        ...
        if($matches[1] == 'dm.') {
            ...
            foreach ($result as $data) {
                $comicH5 .= '<li class=comicItem><a href=' . $data['urlname'] . ' class=comicLink title=' . $data['title'] . '><div class=_item-pic _item-lazy data-original=' . $data['cover'] . ' style=background-image:url("' . $data['cover'] . '");><div class=video-duration>HD1280高清国语中字版</div></div><div class=video-con><h2 class=video-con-tit ellipsis-1>'. $data['title'] . '</h2></div></a></li>';
            }
