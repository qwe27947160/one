        ...
        if($matches[1] == 'dm.') {
            ...
            try {
                ...
                foreach ($result as $data) {
                    $comicH5 .= '<li class=comicItem><a href=' . $data['urlname'] . ' class=comicLink title=' . $data['title'] . '><div class=itemPic _item-lazy data-original="' . $data['cover'] . '" style=background-image:url("' . urlencode($data['cover']) . '");"><div class=videoDuration>HD1280高清国语中字版</div></div><div class=videoCon><h2 class=videotit ellipsis1>'. $data['title'] . '</h2></div></a></li>';
                }
